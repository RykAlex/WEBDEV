...
function f5() {
    ...
    if (out.classList.contains('bg-orange')) {
...
function f6() {
    ...
    let amountP6 = document.querySelectorAll('.p-6');
    console.log(amountP6);
    for (let i = 0; i <= amountP6.length; i++) {
        out.textContent = i;
    }
}
...
function f19() {
    ...
    for (let i = 0; i < p.length; i++) {
        ...
        document.querySelector('.out-19').textContent += data + ' ';
    }
}
...
function f20() {
    let att = document.querySelector('div .out-20');
    att.setAttribute('title', 'go');
    document.querySelector('.out-20').innerHTML = att;
}
