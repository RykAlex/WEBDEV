...
function f1() {
    let num = 1;
    document.querySelector('.out-1').textContent = num;
}
...
function f3() {
    let num = 3;
    document.querySelector('.out-3').textContent = num;
}
...
function f5() {
    ...
    if (i5.checked) {
        document.querySelector('.out-5').textContent = i5.value;
    }
    else {
...
function f7() {
    ...
    if (i7.length >= 6) {
        document.querySelector('.out-71').textContent = i7;
...
function f8() {
    ...
    document.querySelector('.out-8').appendChild(div);
}
...
function f9() {
    ...
    if (r9.checked) {
        document.querySelector('.out-9').textContent = r9.value;
    }
    else {
...
function f10() {
    ...
    document.querySelector('.out-10').style.background = i10;
}
...
function f12() {
    ...
    document.querySelector('.out-12').textContent = i12;
}
...
function f13() {
    ...
    document.querySelector('.out-13').textContent = i13;
}
...
function f14() {
    ...
    document.querySelector('.out-14').textContent = t14.value;
}
...
function f15() {
    ...
    document.querySelector('.t-15').textContent = i15;
    document.querySelector('.out-15').textContent = i15;
...
function f19() {
    ...
    document.querySelector('.i-19').value = out19.innerHTML;
}
...
function f20() {
    ...
    document.querySelector('.s-202').value = s201;
}
