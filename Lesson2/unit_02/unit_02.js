...
//Rykov: Переменная e1 это сторока.Следовательно результат - вывод содержимого двух переменных.
...
function t9() {
    ...
    document.querySelector('.out-9').textContent = data.value;
...
function t10() {
    let data = document.querySelector('.i-10');
    document.querySelector('.out-10').textContent = data.value * 20;
...
function t11() {
    let data = document.querySelector('.i-11');
    document.querySelector('.out-11').textContent = data.value + 55;
}
...
function t12() {
    let hello = 'Hello';
    let name = document.querySelector('.i-12-1');
    let firstName = document.querySelector('.i-12-2');
    document.querySelector('.out-12').textContent = hello + ' ' + name.value + ' ' + firstName.value;
...
function t16() {
    let i1 = document.querySelector('.i-16-1');
    let i2 = document.querySelector('.i-16-2');
...
function t19() {
    let a = document.querySelector('.i-19-1');
    let b = document.querySelector('.i-19-2');
    let sum = (+a.value) + (+b.value);
