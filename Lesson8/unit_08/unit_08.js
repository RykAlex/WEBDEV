...
function t8() {
  ...
  let k = document.querySelector('.i-82').value;
  while (k >= i) {
...
function t9() {
  let i = document.querySelector('.i-91').value;
  let k = document.querySelector('.i-92').value;
  if (i > k) {
    while (k <= i) {
      document.querySelector('.out-9').textContent += k + '_';
      k++;
    }
  }
  else if (i < k) {
